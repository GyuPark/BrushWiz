...
SubProgram "d3d11 " {
Keywords { "SHADOWS_DEPTH" "HIGHLIGHT_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "SHADOWS_CUBE" "HIGHLIGHT_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "SHADOWS_DEPTH" "ODS_RENDER" "HIGHLIGHT_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "SHADOWS_CUBE" "ODS_RENDER" "HIGHLIGHT_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "SHADOWS_DEPTH" "ODS_RENDER_CM" "HIGHLIGHT_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "SHADOWS_CUBE" "ODS_RENDER_CM" "HIGHLIGHT_ON" }
"// shader disassembly not supported on DXBC"
}
}
Program "fp" {
