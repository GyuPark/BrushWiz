...
_MaxDistance ("Screen Space Max Distance", Float) = 7
_RevealSpeed ("Reveal Speed", Float) = 2
...
SubShader {
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Geometry" "RenderType" = "Geometry" "SHADOWSUPPORT" = "true" }
  GpuProgramID 29037
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "PREPASS"
  Tags { "LIGHTMODE" = "PREPASSBASE" "QUEUE" = "Geometry" "RenderType" = "Geometry" }
  GpuProgramID 171025
Program "vp" {
SubProgram "d3d11 " {
"// shader disassembly not supported on DXBC"
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "PREPASS"
  Tags { "LIGHTMODE" = "PREPASSFINAL" "QUEUE" = "Geometry" "RenderType" = "Geometry" }
  ZWrite Off
  GpuProgramID 222168
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "DEFERRED"
  Tags { "LIGHTMODE" = "DEFERRED" "QUEUE" = "Geometry" "RenderType" = "Geometry" }
  GpuProgramID 274127
Program "vp" {
SubProgram "d3d11 " {
"// shader disassembly not supported on DXBC"
