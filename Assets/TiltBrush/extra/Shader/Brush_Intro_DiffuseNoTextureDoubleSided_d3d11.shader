...
SubShader {
 ...
 Pass {
  Name "FORWARD"
  Tags { "DisableBatching" = "true" "LIGHTMODE" = "FORWARDBASE" "SHADOWSUPPORT" = "true" }
  Cull Off
  GpuProgramID 61331
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  Tags { "DisableBatching" = "true" "LIGHTMODE" = "FORWARDADD" }
  ZWrite Off
  Cull Off
  GpuProgramID 78472
Program "vp" {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "PREPASS"
  Tags { "DisableBatching" = "true" "LIGHTMODE" = "PREPASSBASE" }
  Cull Off
  GpuProgramID 174792
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "PREPASS"
  Tags { "DisableBatching" = "true" "LIGHTMODE" = "PREPASSFINAL" }
  ZWrite Off
  Cull Off
  GpuProgramID 251094
Program "vp" {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "DEFERRED"
  Tags { "DisableBatching" = "true" "LIGHTMODE" = "DEFERRED" }
  Cull Off
  GpuProgramID 296390
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "ShadowCaster"
  Tags { "DisableBatching" = "true" "LIGHTMODE" = "SHADOWCASTER" "SHADOWSUPPORT" = "true" }
  Cull Off
  GpuProgramID 356261
Program "vp" {
SubProgram "d3d11 " {
